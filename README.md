...
A straightforward option is to utilize Node.js's built-in web server. Follow these steps:
If you struggle with Tomcat, consider using Node.js as an alternative web server.
